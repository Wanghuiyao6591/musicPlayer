$(function(){
	...
	$('.open_list').on('click',function(){
		...
		if(attr=='display:none'){
			...
			$('.open_list span').text(musics.length);
		}else{
	...
	//添加音乐
	var musics=[
		{src:'./song/1.mp3',name:'鬼迷心窍',art:'李宗盛',time:'03:23'},
		{src:'./song/2.mp3',name:'擦干你的泪',art:'郑源',time:'04.00'},
		{src:'./song/3.mp3',name:'后会无期',art:'邓紫棋',time:'03:43'},
		{src:'./song/4.mp3',name:'瞬间',art:'邓紫棋',time:'04.06'},
		{src:'./song/5.mp3',name:'喜欢你',art:'邓紫棋',time:'03.59'},
		{src:'./song/6.mp3',name:'新的心跳',art:'邓紫棋',time:'03.36'},
	];
